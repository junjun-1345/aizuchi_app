...
class _$DailyImpl implements _Daily {
  const _$DailyImpl(
      {this.emotion, this.summary, @TimestampConverter() this.createdAt});
  ...
  @override
  String toString() {
    return 'Daily(emotion: $emotion, summary: $summary, createdAt: $createdAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, emotion, summary, createdAt);
...
abstract class _Daily implements Daily {
  const factory _Daily(
      {final String? emotion,
      final String? summary,
      @TimestampConverter() final DateTime? createdAt}) = _$DailyImpl;
