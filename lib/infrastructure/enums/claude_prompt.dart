...
extension ClaudePromptExtension on ClaudePrompt {
  static final promptValues = {
    ClaudePrompt.summary: "本日の会話をすべて送信するので、その会話の内容を２０文字以内の１行日記のようにまとめてください。",
    ClaudePrompt.joyful:
  ...
  static ClaudePrompt from(String rawValue) {
    return ClaudePrompt.values.firstWhere(
      (e) {
...
ClaudePrompt convertToClaudePrompt(EmotionType emotionType) {
  switch (emotionType) {
    case EmotionType.joyful:
      return ClaudePrompt.joyful;
    case EmotionType.content:
      return ClaudePrompt.content;
    case EmotionType.neutral:
      return ClaudePrompt.neutral;
    case EmotionType.discontent:
      return ClaudePrompt.discontent;
    case EmotionType.sad:
      return ClaudePrompt.sad;
    default:
      return ClaudePrompt.summary;
  }
}
